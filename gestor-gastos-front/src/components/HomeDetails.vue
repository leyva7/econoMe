...
export default {
  ...
  setup() {
    ...
    const updateData = async (selection) => {
      ...
      hasData.value = categoriesDifferences.value && categoriesDifferences.value.spentDifferences && Object.keys(categoriesDifferences.value.spentDifferences).length > 0;
